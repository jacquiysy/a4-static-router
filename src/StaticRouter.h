...
private:
    ...
    void sendIp(const Packet& packet, const std::string& out_iface, const std::string& in_iface, uint32_t ip, uint16_t ethType, std::optional<mac_addr> nextMac, sr_ethernet_hdr_t* eth_hdr);
